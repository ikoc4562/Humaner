...
if (@$_POST['isGuncelle'])
{
    $sql=$db->prepare('update contactinfo set email=:email,phone=:phone,address=:address,googlemaps=:googlemaps where id=:id');
    $sql->execute(['email'=>$_POST['email'],'phone'=>$_POST['phone'],'address'=>$_POST['address'],'googlemaps'=>$_POST['googlemaps'],'id'=>$_GET['id']]);
    ?>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="googlemaps" value="<?= htmlentities($googlemaps)?>">
