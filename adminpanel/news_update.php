...
if (@$_POST['isGuncelle'])
{
    if (@$_FILES['fotograf']['name']<>'')
    {
        ...
        $sql=$db->prepare('update articles set title=:title,is_deleted=:is_deleted,picture=:resim,publish_date=:publish_date,text=:text where id=:id');
        $sql->execute(['title'=>$_POST['title'],'is_deleted'=>0,'id'=>$_GET['id'],'resim'=>$resim ,'publish_date'=>$_POST['publish_date'],'text'=>$_POST['text']]);

    }
    else
    {
        $sql=$db->prepare('update articles set title=:title,publish_date=:publish_date,is_deleted=:is_deleted,text=:text where id=:id');
        $sql->execute(['title'=>$_POST['title'],'id'=>$_GET['id'],'is_deleted'=>0,'publish_date'=>$_POST['publish_date'],'text'=>$_POST['text']]);
  ...
  <div class="content-wrapper">
      ...
      <div class="box box-primary">
          <div class="box-header with-border">
              <h3 class="box-title">Add New News & Articles</h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
          <form method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                  ...
                  <div class="form-group">
                      ...
                      <input  type="datetime-local" class="form-control" name="publish_date" value="<?=$events[0]['publish_date']?>">
                  </div>
