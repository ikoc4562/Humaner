...
if ($_GET['islem']=='guncelle' and @$_GET['id'])
{
    ...
    $logofooter=$sonuclar[0]['logofooter'];
    ...
    $about_image=$sonuclar[0]['about_image'];
    /*
...
if (@$_POST['isKaydet'])
{
    if(@$_POST['id'])
    {
        ...
        {
            $hedef = "../images/";
            $kaynak2 = $_FILES["logofooter"]["tmp_name"];
            $resim2 = $_FILES["logofooter"]["name"];
            $rtipi2 = $_FILES["logofooter"]["type"];
            $rboyut2 = $_FILES["logofooter"]["size"];
            $ruzanti2 	= substr($resim2, -4);
            $yeniad2	= substr(uniqid(md5(rand())), 0,15);
            $resim2 = $yeniad2.$ruzanti2;
            ...
            $sql=$db->prepare('update about set logofooter=:logofooter where id=:id');
            $sql->execute([
                'logofooter'=>$resim2,
                'id'=>$_GET['id']
            ]);
        ...
        {
            $hedef = "../images/";
            $kaynak2 = $_FILES["about_image"]["tmp_name"];
            $resim2 = $_FILES["about_image"]["name"];
            $rtipi2 = $_FILES["about_image"]["type"];
            $rboyut2 = $_FILES["about_image"]["size"];
            $ruzanti2 	= substr($resim2, -4);
            $yeniad2	= substr(uniqid(md5(rand())), 0,15);
            $resim2 = $yeniad2.$ruzanti2;
            ...
            $sql=$db->prepare('update about set about_image=:about_image where id=:id');
            $sql->execute([
                'about_image'=>$resim2,
                'id'=>$_GET['id']
            ]);
