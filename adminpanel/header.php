...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index.php" class="logo">
            ...
            <span class="logo-lg"><img src="../images/<?=$hakkinda[0]['logo']?>" height="30px"></span>
        </a>
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    foreach ($sonuclar as $sonuc) {
                                        ?>
                                        <li><!-- start message -->
                                            <a href="mesajlar.php?islem=guncelle&id=5">
                                                <div class="pull-left">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="profil.php?id=5" class="btn btn-default btn-flat">Profile</a>
                                </div>
